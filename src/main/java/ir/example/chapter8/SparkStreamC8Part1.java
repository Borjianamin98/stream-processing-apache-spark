...
public class SparkStreamC8Part1 {

    private static final Logger log = LoggerFactory.getLogger(SparkStreamC8Part1.class);
    ...
    public static void main(String[] args) {
        ...
        Dataset<Row> rankingURLStream = urlWebLogStream
                ...
                .groupBy(col("request"), window(col("timestamp"), "3 minutes", "1 minute"))
                .count();
