...
public class SparkStreamC13Part3 {

    private static final Logger log = LoggerFactory.getLogger(SparkStreamC13Part3.class);
        ...
        FlatMapGroupsWithStateFunction<String, WebLog, BufferState, WebLogBytesAverage> mappingFunction =
                (key, values, state) -> {
                    ...
                    if (state.hasTimedOut()) {
                        ...
                        Iterator<WebLogBytesAverage> result = stateToBytesAverage(key, state.get(), elementWindowSize);
                    ...
                    return stateToBytesAverage(key, updatedState, elementWindowSize);
                };
    ...
    private static Iterator<WebLogBytesAverage> stateToBytesAverage(
            String key, BufferState state, int elementWindowSize) {
        List<WebLog> data = state.getData();
