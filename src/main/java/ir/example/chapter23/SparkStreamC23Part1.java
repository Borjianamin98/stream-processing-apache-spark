...
public class SparkStreamC23Part1 {

    private static final Logger log = LoggerFactory.getLogger(SparkStreamC23Part1.class);
    ...
    public static void main(String[] args) {
        ...
        webLogJavaDStream.foreachRDD(webLogJavaRDD -> {
            Dataset<WebLog> df = sparkSession.createDataset(webLogJavaRDD.rdd(), Encoders.bean(WebLog.class));
            df.write().format("parquet").mode(SaveMode.Append).save(PathUtility.PROJECT_OUTPUT_PATH);
        });
