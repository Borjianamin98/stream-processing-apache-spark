...
public class SparkStreamC9Part4 {

    private static final Logger log = LoggerFactory.getLogger(SparkStreamC9Part4.class);
    ...
    public static void main(String[] args) {
        ...
        Dataset<Row> rawData = sparkSession.readStream()
                .format("kafka")
                .option("kafka.bootstrap.servers", "localhost:" + 7950)
