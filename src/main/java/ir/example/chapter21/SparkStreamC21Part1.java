...
public class SparkStreamC21Part1 {

    private static final Logger log = LoggerFactory.getLogger(SparkStreamC21Part1.class);
    ...
    public static void main(String[] args) {
        ...
        JavaDStream<WebLog> windowedWebLog = webLogJavaDStream.window(Duration.apply(10_000));
