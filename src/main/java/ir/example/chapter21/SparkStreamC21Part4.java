...
public class SparkStreamC21Part4 {

    private static final Logger log = LoggerFactory.getLogger(SparkStreamC21Part4.class);
    ...
    public static void main(String[] args) {
        ...
        JavaPairDStream<String, Integer> hostCount = webLogJavaDStream
                ...
                .reduceByKeyAndWindow(Integer::sum, (v1, v2) -> v1 - v2,
                        Duration.apply(24 * 60 * 6 * 10_000), Duration.apply(10_000));
