...
public class SparkStreamC21Part3 {

    private static final Logger log = LoggerFactory.getLogger(SparkStreamC21Part3.class);
    ...
    public static void main(String[] args) {
        ...
        JavaPairDStream<String, Integer> hostCount = webLogJavaDStream
                .mapToPair(record -> new Tuple2<>(record.getHost(), 1))
                .reduceByKeyAndWindow(Integer::sum, Duration.apply(24 * 60 * 6 * 10_000), Duration.apply(10_000));
