...
public class SparkStreamC21Part2 {

    private static final Logger log = LoggerFactory.getLogger(SparkStreamC21Part2.class);
    ...
    public static void main(String[] args) {
        ...
        // Although batch interval is 5 seconds, but 'print' output produce each 10 seconds (for records in last
        // 20 seconds or 4 last batch interval)
        JavaDStream<WebLog> windowedWebLog = webLogJavaDStream.window(Duration.apply(20_000), Duration.apply(10_000));
        JavaPairDStream<String, Integer> hostCount = windowedWebLog
                .mapToPair(record -> new Tuple2<>(record.getHost(), 1))
